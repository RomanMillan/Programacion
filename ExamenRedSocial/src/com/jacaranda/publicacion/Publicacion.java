...
public abstract class Publicacion implements Valorable, Comparable<Publicacion>{
	...
	//hashCode and Equals (fechaCreaci�n y texto)
	@Override
	public int hashCode() {
	...
	public String toString() {
		return "Publicaci�n" + texto + ". Realizada por: " + getLoginUsuario()
		+ ". Valoraci�n: " + getValoracion() + ". Fecha de publicacion: " + getFechaCreacion();
	}
